...
class Inscription extends MyDatabase {
    ...
    public function add_user_to_db($username, $arobase, $birthday, $email, $hash_mdp, $token){
        ...
        INSERT INTO `photo_de_profil`(`image_url`, `id_user`) VALUES ('http://localhost/tweet_academie/view/upload/photo/profil.jpg', @user_id);
        INSERT INTO `cover`(`cover_url`, `id_user`) VALUES ('http://localhost/tweet_academie/view/upload/cover/cover.jpg', @user_id);");
